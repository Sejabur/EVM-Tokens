...
// TAX                    : 20%
// -> 5% Marketing Wallet
// -> 5% BUSD Redistribution
// -> 5% BNB Redistribution
// -> 5% PancakeSwap liquidity 
// ----------------------------------------------------------- //

pragma solidity ^0.8.4;

// Importing Necessary Filesƒ
import "./Context.sol";
import "./IERC20.sol";
import "./ERC20.sol";
import "./Ownable.sol";
...
contract TUKAR is ERC20, Ownable {
    ...
    constructor() ERC20("TUKAR", "TUKAR") {
    	wbnbDividendTracker = new WrappedBNBDividendTracker();
    	busdDividendTracker = new BusdDividendTracker();

    	marketingWallet = 0x2b5Cf6381dBFd33cb8cf9F3C2c1d3C63a23BaDcd; // Marketing Wallet
    ...
    function afterPreSale() external onlyOwner {
        ...
        swapTokensAtAmount = 2000000 * (10**8);
        maxBuyTranscationAmount = 5000000000 * (10**8);
        maxSellTransactionAmount = 500000000 * (10**8);
        maxWalletToken = 10000000000 * (10**8);
    }
...
contract WrappedBNBDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DIGITALFIAT_WrappedBNB_Dividend_Tracker", "BWDT", 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c) {
    	claimWait = 60;
        minimumTokenBalanceForDividends = 100000 * (10**8); //must hold 100000+ tokens
    }
